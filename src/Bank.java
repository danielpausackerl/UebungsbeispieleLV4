...
public class Bank {
	...
	public static void main(String[] args) {
		...
		Gehaltskonto konto1 = new Gehaltskonto("Max Mustermann", "AT541223", "STASDF12");
		Gehaltskonto konto2 = new Gehaltskonto("Susi Sorglos", "AT344234", "STASDF12");
		Gehaltskonto konto3 = new Gehaltskonto("John Smith", "US1324353", "USJKLM44");
